// Added timeline range bar
// to veiw change of gdp,population,life_expectancy in ranking and scatter plot layout
...
var continents = ["America","Africa","Asia","Europe","Oceania"];
...
//layout
d3.select("input[value=\"0\"]").on("click", force_layout);
...
function mouseovered(d) {
  ...
  node 
	...
	node
      .classed("node--light", function(n) { return n.light; })
  ...
  //node
      //.classed("node--colored", function(n) { return n.attr("opacity", "1"); })
